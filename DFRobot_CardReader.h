...
public:
    ...
    /**
     * @brief Reads the unique identifier (UUID) of the card.
     * @param UUID Pointer to a buffer for storing the UUID.
     * @return The length of the UUID in bytes.
     */
...
private:
    ...
    unsigned char UID[5]                                                  ;
    unsigned char Password_Buffer[6]                                      ;                       ;
